...
export const LABELS = {
    ...
    SHOW_FRESHNESS: 'Show Account Freshness',
    SHOW_BLOCK_BUTTONS: 'Show Block Buttons',
    SHOW_REPORT_BUTTONS: 'Show Report Buttons',
...
export const STORAGE_KEYS = {
    ...
    FRESHNESS_TOGGLE_STATE: 'freshnessToggleState',
    BLOCK_BUTTONS_TOGGLE_STATE: 'blockButtonsToggleState',
    REPORT_BUTTONS_TOGGLE_STATE: 'reportButtonsToggleState',
